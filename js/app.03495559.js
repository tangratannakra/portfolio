...
var gsap_all = __webpack_require__(12);

// EXTERNAL MODULE: ./node_modules/gsap/TextPlugin.js + 1 modules
var TextPlugin = __webpack_require__(30);

// EXTERNAL MODULE: ./node_modules/gsap/ScrollToPlugin.js
var ScrollToPlugin = __webpack_require__(17);
...
gsap_all["a" /* default */].registerPlugin(ScrollToPlugin["a" /* default */]); // window.onload = introHandler + hideInitial;

var redShift_tl = gsap_all["a" /* default */].timeline();
var tl2 = gsap_all["a" /* default */].timeline();
var played;
Promise.resolve(hideInitial()).then(function () {
  setTimeout(introHandler, 500);
});

function hideInitial() {
  redShift_tl.set(['.heading-nav__menu', '#my-name-intro', '#animation-text-bottom', '.package', '#animation-text-top', '#animation-text-bottom'], {
    opacity: 0
  });
}
...
var web_dom_collections_for_each = __webpack_require__(22);
...
var ScrollTrigger = __webpack_require__(10);
  ...
  _createClass(Menu, [{
    ...
    value: function events() {
      ...
      window.addEventListener("resize", debounce_default()(function () {
        ...
        if (_this.menu.classList.contains('menu-visible') && _this.browserWidth > 768) {
          _this.menu.classList.remove('menu-visible');
        } else if (_this.menuToggler.checked && _this.browserWidth < 768) {
          _this.menu.classList.add('menu-visible');
        }
      }, 333));
...
var es_symbol = __webpack_require__(49);
...
// EXTERNAL MODULE: ./src/scripts/gitHubPr/gitData.json
var gitData = __webpack_require__(79);
...
var gitContainer = document.getElementById('github-projects');
var served;
...
var lazysizes = __webpack_require__(126);
...
var recentPrData = [{
  thumb: 'src/img/prjcts/rodina-small.jpg 600w, src/img/prjcts/rodina.jpg 1200w',
  title: 'Rodina-Haskovo LTD',
  description: 'Custom Template / Wordpress / Site Admin',
  url: 'http://rodinahaskovo.com/'
}, {
  thumb: 'src/img/prjcts/interlabor-small.jpg 600w, src/img/prjcts/interlabor.jpg 1200w',
  title: 'Interlabor',
  description: 'Custom CSS / Custom JavaScript / Site Admin',
  url: 'http://www.inlab-bg.com/'
}, {
  thumb: 'src/img/prjcts/chervenataStena-small.jpg 600w, src/img/prjcts/chervenataStena.jpg 1200w',
  title: 'Chervenata Stena Park',
  description: 'UX/UI / WorpdPress / Custom CSS',
  url: 'http://chervenatastena.com/'
}, {
  thumb: 'src/img/prjcts/swissboutique.jpg 600w, src/img/prjcts/swissboutique.jpg 1200w',
  title: 'Swiss Boutique',
  description: 'JS Customization / Custom CSS / Site Admin',
  url: 'https://swissboutique.bg/'
}, {
  thumb: 'src/img/prjcts/phototravel-small.jpg 600w, src/img/prjcts/phototravel.jpg 1200w',
  title: 'PhotoTravel',
  description: 'WordPress and Custom CSS',
  url: 'http://phototravel.bg'
}, {
  thumb: 'src/img/prjcts/realestate-small.jpg 600w, src/img/prjcts/realestate.jpg 1200w',
...
module.exports = JSON.parse("[{\"node\":{\"name\":\"Real-Estate-Agency-Front-Page\",\"description\":\"Single Page / Front Page Design and implementation with Bootstrap 4, JS and custom CSS\",\"homepageUrl\":\"https://tangratannakra.github.io/Real-Estate-Agency-Front-Page/\",\"languages\":{\"totalCount\":2}}},{\"node\":{\"name\":\"Shop-Single-Page\",\"description\":\"single product page HTML/SCSS/ES6 \",\"homepageUrl\":\"https://tangratannakra.github.io/Shop-Single-Page/\",\"languages\":{\"totalCount\":3}}},{\"node\":{\"name\":\"Read\",\"description\":\"Single/Front page web for book reviewing. HTML/CSS/JS/Bootstrap\",\"homepageUrl\":\"https://tangratannakra.github.io/Read/\",\"languages\":{\"totalCount\":2}}},{\"node\":{\"name\":\"StopWatch\",\"description\":\"HTML/CSS/UI/Canvas/SVG/JS/ES6 \",\"homepageUrl\":\"https://tangratannakra.github.io/StopWatch/index.html\",\"languages\":{\"totalCount\":3}}},{\"node\":{\"name\":\"web-form-prj\",\"description\":\"small webform \",\"homepageUrl\":\"https://tangratannakra.github.io/web-form-prj/index.html\",\"languages\":{\"totalCount\":3}}}]");
...
/******/ });
//# sourceMappingURL=app.03495559.js.map