...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "v", function() { return gsap; });
...
/* unused harmony export TweenMax */
/* harmony import */ var _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
/* harmony import */ var _CSSPlugin_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(13);


var gsapWithCSS = _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* gsap */ "x"].registerPlugin(_CSSPlugin_js__WEBPACK_IMPORTED_MODULE_1__[/* CSSPlugin */ "a"]) || _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* gsap */ "x"],
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return CSSPlugin; });
...
_removeProperty = function _removeProperty(target, property) {
  ...
  var pt = new _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* PropTween */ "b"](plugin._pt, target, property, 0, 1, onlySetAtEnd ? _renderNonTweeningValueOnlyAtEnd : _renderNonTweeningValue);
  plugin._pt = pt;
  pt.b = beginning;
  pt.e = end;
...
_convertToUnit = function _convertToUnit(target, property, value, unit) {
  ...
  if (toPercent && (_transformProps[property] || ~property.indexOf("adius"))) {
    ...
    return Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _round */ "s"])(curValue / (isSVG ? target.getBBox()[horizontal ? "width" : "height"] : target[measureProperty]) * amount);
  }
  ...
  if (cache && toPercent && cache.width && horizontal && cache.time === _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _ticker */ "u"].time) {
    return Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _round */ "s"])(curValue / cache.width * amount);
  } else {
    ...
    if (horizontal && toPercent) {
      cache = Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _getCache */ "g"])(parent);
      cache.time = _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _ticker */ "u"].time;
      cache.width = parent[measureProperty];
    }
  }

  return Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _round */ "s"])(toPixels ? px * curValue / amount : px && curValue ? amount / px * curValue : 0);
},
  ...
  if (_transformProps[property] && property !== "transform") {
    ...
    if (!value || value === "auto" || uncache || ~(value + "").indexOf("calc(")) {
      value = _specialProps[property] && _specialProps[property](target, property, unit) || _getComputedProperty(target, property) || Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _getProperty */ "h"])(target, property) || (property === "opacity" ? 1 : 0); // note: some browsers, like Firefox, don't report borderRadius correctly! Instead, it only reports every corner like  borderTopLeftRadius
    }
  }
  ...
  var pt = new _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* PropTween */ "b"](this._pt, target.style, prop, 0, 1, _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _renderComplexString */ "q"]),
      index = 0,
      matchIndex = 0,
      a,
      result,
  ...
  Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _colorStringFilter */ "d"])(a); //pass an array with the starting and ending values and let the filter do whatever it needs to the values. If colors are found, it returns true and then we must match where the color shows up order-wise because for things like boxShadow, sometimes the browser provides the computed values with the color FIRST, but the user provides it with the color LAST, so flip them if necessary. Same for drop-shadow().


  start = a[0];
  end = a[1];
  startValues = start.match(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _numWithUnitExp */ "n"]) || [];
  endValues = end.match(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _numWithUnitExp */ "n"]) || [];

  if (endValues.length) {
    while (result = _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _numWithUnitExp */ "n"].exec(end)) {
      endValue = result[0];
      chunk = end.substring(index, result.index);
      ...
      if (endValue !== (startValue = startValues[matchIndex++] || "")) {
        ...
        index = _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _numWithUnitExp */ "n"].lastIndex - endUnit.length;

        if (!endUnit) {
          //if something like "perspective:300" is passed in and we must add a unit to the end
          endUnit = endUnit || _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _config */ "e"].units[prop] || startUnit;
  ...
  if (_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _relExp */ "p"].test(end)) {
    pt.e = 0; //if the end string contains relative values or dynamic random(...) values, delete the end it so that on the final render we don't actually set it to the string with += or -= characters (forces it to use the calculated value).
  }
...
_specialProps = {
  clearProps: function clearProps(plugin, target, property, endValue, tween) {
    if (tween.data !== "isFromStart") {
      var pt = plugin._pt = new _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* PropTween */ "b"](plugin._pt, target, property, 0, 0, _renderClearProps);
      pt.u = endValue;
      pt.pr = -10;
      pt.tween = tween;
...
_identity2DMatrix = [1, 0, 0, 1, 0, 0],
  ...
  return _isNullTransform(matrixString) ? _identity2DMatrix : matrixString.substr(7).match(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _numExp */ "m"]).map(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _round */ "s"]);
},
    _getMatrix = function _getMatrix(target, force2D) {
  var cache = target._gsap || Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _getCache */ "g"])(target),
      style = target.style,
  ...
  var cache = target._gsap || new _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* GSCache */ "a"](target);
  ...
  if (matrix !== _identity2DMatrix) {
    ...
    if (matrix.length === 6) {
      ...
      scaleX = Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _round */ "s"])(Math.sqrt(a * a + b * b + c * c));
      scaleY = Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _round */ "s"])(Math.sqrt(a22 * a22 + a32 * a32));
  ...
  cache.z = z + px;
  cache.scaleX = Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _round */ "s"])(scaleX);
  cache.scaleY = Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _round */ "s"])(scaleY);
  cache.rotation = Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _round */ "s"])(rotation) + deg;
  cache.rotationX = Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _round */ "s"])(rotationX) + deg;
  cache.rotationY = Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _round */ "s"])(rotationY) + deg;
  ...
  cache.xOffset = cache.yOffset = 0;
  cache.force3D = _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _config */ "e"].force3D;
...
_addPxTranslate = function _addPxTranslate(target, start, value) {
  var unit = Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* getUnit */ "w"])(start);
  return Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _round */ "s"])(parseFloat(start) + parseFloat(_convertToUnit(target, "x", value + "px", unit))) + unit;
},
  ...
  if (rotation || skewX) {
    ...
    a11 = Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _round */ "s"])(a11);
    a21 = Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _round */ "s"])(a21);
    a12 = Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _round */ "s"])(a12);
    a22 = Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _round */ "s"])(a22);
  } else {
    a11 = scaleX;
    a22 = scaleY;
    a21 = a12 = 0;
  ...
  if (xOrigin || yOrigin || xOffset || yOffset) {
    tx = Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _round */ "s"])(tx + xOrigin - (xOrigin * a11 + yOrigin * a12) + xOffset);
    ty = Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _round */ "s"])(ty + yOrigin - (xOrigin * a21 + yOrigin * a22) + yOffset);
  }

  if (xPercent || yPercent) {
    //The SVG spec doesn't support percentage-based translation in the "transform" attribute, so we merge it into the translation to simulate it.
    temp = target.getBBox();
    tx = Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _round */ "s"])(tx + xPercent / 100 * temp.width);
    ty = Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _round */ "s"])(ty + yPercent / 100 * temp.height);
  }
  ...
  var cap = 360,
      isString = Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _isString */ "j"])(endValue),
  ...
  plugin._pt = pt = new _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* PropTween */ "b"](plugin._pt, target, property, startNum, change, _renderPropWithEnd);
  pt.e = finalValue;
  pt.u = "deg";
  ...
  for (p in _transformProps) {
    ...
    if (startValue !== endValue && exclude.indexOf(p) < 0) {
      ...
      startUnit = Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* getUnit */ "w"])(startValue);
      endUnit = Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* getUnit */ "w"])(endValue);
      startNum = startUnit !== endUnit ? _convertToUnit(target, p, startValue, endUnit) : parseFloat(startValue);
      endNum = parseFloat(endValue);
      plugin._pt = new _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* PropTween */ "b"](plugin._pt, startCache, p, startNum, endNum - startNum, _renderCSSProp);
...
Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _forEachName */ "f"])("padding,margin,Width,Radius", function (name, index) {
  var t = "Top",
      r = "Right",
      b = "Bottom",
      l = "Left",
...
var CSSPlugin = {
  ...
  init: function init(target, vars, tween, index, targets) {
    ...
    for (p in vars) {
      ...
      if (_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _plugins */ "o"][p] && Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _checkPlugin */ "c"])(p, vars, tween, index, target, targets)) {
        //plugins
        continue;
      }
      ...
      if (type === "string" && ~endValue.indexOf("random(")) {
        endValue = Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _replaceRandom */ "r"])(endValue);
      }
      ...
      if (specialProp) {
        ...
        if (isTransformRelated) {
          if (!transformPropTween) {
            ...
            transformPropTween = this._pt = new _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* PropTween */ "b"](this._pt, style, _transformProp, 0, 1, cache.renderTransform, cache, 0, -1); //the first time through, create the rendering PropTween so that it runs LAST (in the linked list, we keep adding to the beginning)

            transformPropTween.dep = 1; //flag it as dependent so that if things get killed/overwritten and this is the only PropTween left, we can safely kill the whole tween.
          }

          if (p === "scale") {
            this._pt = new _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* PropTween */ "b"](this._pt, cache, "scaleY", cache.scaleY, relative ? relative * endNum : endNum - cache.scaleY);
            props.push("scaleY", p);
            p += "X";
        ...
        if (isTransformRelated || (endNum || endNum === 0) && (startNum || startNum === 0) && !_complexExp.test(endValue) && p in style) {
          ...
          endUnit = (endValue + "").substr((endNum + "").length) || (p in _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _config */ "e"].units ? _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _config */ "e"].units[p] : startUnit);

          if (startUnit !== endUnit) {
            startNum = _convertToUnit(target, p, startValue, endUnit);
          }

          this._pt = new _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* PropTween */ "b"](this._pt, isTransformRelated ? cache : style, p, startNum, relative ? relative * endNum : endNum - startNum, endUnit === "px" && vars.autoRound !== false && !isTransformRelated ? _renderRoundedCSSProp : _renderCSSProp);
          ...
          if (p in target) {
            ...
            Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _missingPlugin */ "l"])(p, endValue);
    ...
    if (hasPriority) {
      Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _sortPropTweensByPriority */ "t"])(this);
    }
  },
  get: _get,
  ...
  getSetter: function getSetter(target, property, plugin) {
    ...
    return property in _transformProps && property !== _transformOriginProp && (target._gsap.x || _get(target, "x")) ? plugin && _recentSetterPlugin === plugin ? property === "scale" ? _setterScale : _setterTransform : (_recentSetterPlugin = plugin || {}) && (property === "scale" ? _setterScaleWithRender : _setterTransformWithRender) : target.style && !Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _isUndefined */ "k"])(target.style[property]) ? _setterCSSStyle : ~property.indexOf("-") ? _setterCSSProp : Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _getSetter */ "i"])(target, property);
  },
  core: {
...
_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* gsap */ "x"].utils.checkPrefix = _checkPropPrefix;

(function (positionAndScale, rotation, others, aliases) {
  var all = Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _forEachName */ "f"])(positionAndScale + "," + rotation + "," + others, function (name) {
    _transformProps[name] = 1;
  });

  Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _forEachName */ "f"])(rotation, function (name) {
    _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _config */ "e"].units[name] = "deg";
    _rotationalProperties[name] = 1;
  });

  _propertyAliases[all[13]] = positionAndScale + "," + rotation;

  Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _forEachName */ "f"])(aliases, function (name) {
    var split = name.split(":");
    _propertyAliases[split[1]] = all[split[0]];
  });
})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent", "rotation,rotationX,rotationY,skewX,skewY", "transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective", "0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");

Object(_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _forEachName */ "f"])("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective", function (name) {
  _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* _config */ "e"].units[name] = "px";
});

_gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* gsap */ "x"].registerPlugin(CSSPlugin);
...
var gsapWithCSS = _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* default */ "v"].registerPlugin(_CSSPlugin_js__WEBPACK_IMPORTED_MODULE_1__[/* default */ "b"]) || _gsap_core_js__WEBPACK_IMPORTED_MODULE_0__[/* default */ "v"], // to protect from tree shaking
	TweenMaxWithCSS = gsapWithCSS.core.Tween;
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "a", function() { return /* binding */ TextPlugin; });

// UNUSED EXPORTS: TextPlugin
...
var defineWellKnownSymbol = __webpack_require__(105);
...
var buildFullPath = __webpack_require__(121);
...
var mergeConfig = __webpack_require__(74);
...
//# sourceMappingURL=1.f0975500.chunk.js.map